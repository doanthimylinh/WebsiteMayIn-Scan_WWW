								...
								<table style="margin: auto; margin-left: 60px;" class="col-md-6">
									...
									<tr>
										...
										<td><input type="text" class="form-control"
											...
											placeholder="Nhập tên..." name="productName" /></td>
									</tr>
									<tr>
										<th>Mô tả:</th>
										<td><textarea required="required" class="form-control"
												placeholder="Nhập mô tả..." rows="4" name="description"></textarea></td>
									</tr>
									<tr>
										<th></th>
										<td></td>
								...
								<table
									...
									<tr>
										...
										<td><input type="number" class="form-control" min="1"
											...
											placeholder="1.00 VND" name="price" /></td>
									</tr>
									<tr>
										<th>Số lượng:</th>
										<td><input type="number" class="form-control" min="1"
											required="required" style="height: 30px; width: 230px;"
											placeholder="1" name="quantity" /></td>
									</tr>
									<tr>
										<th>Hình ảnh:</th>
