												...
												<div class="panel-heading">
													...
													<p class="demo-button">
														<a class="btn btn-default" href="product-list"
															style="padding: 4px 8px; text-decoration: none; border: none;">Tất
															...
															background-color: gray; padding: 4px 8px; text-decoration: none; border: none; margin-left: 7px;">Máy
															...
															background-color: gray; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Máy
															...
															background-color: gray; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">
															Máy in kim - hóa đơn - Bill</a> <a class="btn btn-danger"
															...
															background-color: gray; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Linh
															kiện máy in</a>
													</p>
													<div class="right">
														
														<a href="product-create"><span
															class="label label-success" style="font-size: 15px;">Thêm mới</span></a>
													</div>
												</div>
