								...
								<table
									...
									<tr>
										...
										<td><input type="text" class="form-control"
											style="height: 30px;" placeholder="Nhập họ tên..."
									...
									<tr>
										...
										<td><textarea required="required" class="form-control"
												placeholder="Nhập địa chỉ..." rows="4" name="address">${user.address}</textarea></td>
									</tr>
									<tr>
										<th></th>
										<td></td>
								...
								<table style="margin: auto; margin-right: 30px;"
									...
									<tr>
										...
										<td><input type="password" class="form-control"
											style="height: 30px;" placeholder="Nhập mật khẩu..."
											name="password" /></td>
									</tr>
									<tr>
										<th>Nhập lại mật khẩu:</th>
										<td><input type="password" class="form-control"
											style="height: 30px;" placeholder="Nhập lại mật khẩu..."
											name="repassword" /></td>
									</tr>
									<tr>
										<th></th>
